...
if [[ $DATASET_NAME == "e2h" ]]; then
    SPLIT=train
    PREFIX=PREFIX_TO_YOUR_MODEL #For example: e2h_ema_0.9999_420000_adapted/sample_420000
    ...
    SPLIT=train
    PREFIX=PREFIX_TO_YOUR_MODEL #For example: diode_ema_0.9999_440000_adapted/sample_440000
    ...
    SPLIT=test
    PREFIX=PREFIX_TO_YOUR_MODEL #For example: imagenet256_inpaint_ema_0.9999_400000/sample_400000
