...
from ddbm.train_distill_util import TrainLoopDistill
...
def main(args):
    ...
    logger.log("training...")
    train_class = TrainLoopDistill if args.distillation else TrainLoop
    train_class(
        model=model,
        diffusion=diffusion,
        train_data=data,
        ...
        n_bridge_loop=args.n_bridge_loop,
        resume_student_checkpoint=args.resume_student_checkpoint,
