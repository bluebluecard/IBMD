...
def get_recon_imgs_fn(opt, nfe):
    sample_dir = RESULT_DIR / opt.ckpt / "samples_nfe{}{}{}".format(nfe, "_clip" if opt.clip_denoise else "", opt.checkpoint_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--port",           type=str,  default="6021",        help="The port for the master process")
    ...
    parser.add_argument("--checkpoint-name", type=str, default="latest.pt", help="the model checkpoint name")

    parser.add_argument("--model-add-noise-input", action="store_true", help="add noise channels to the input of the student")
