...
def create_training_options():
    ...
    # parser.add_argument("--exponential-time-probability-coeff", type=float, default=10, help="")
    ...
    parser.add_argument("--save_every_iter", type=int, default=100, help="")
...
def main(opt):
    ...
    train_dataset = imagenet.build_lmdb_dataset_lmdb_folder_path(opt, log, train=True, 
                                                                 lmdb_folder_path=opt.lmdb_folder_path)
    val_dataset   = imagenet.build_lmdb_dataset_lmdb_folder_path(opt, log, train=False,
                                                                 lmdb_folder_path=opt.lmdb_folder_path)
